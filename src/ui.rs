...
fn draw_chain_borders(
    ...
    let mut side_left = get_chain_border(5, 27, (-21., 0.));
    let mut side_right = get_chain_border(5, 27, (21., 0.));
    let mut all = Vec::new();
    ...
    for chain in all{
        commands.spawn((
            SpriteSheetBundle {
                ...
                transform: Transform {
                    translation: Vec3{ x: chain.position.0 as f32, y: chain.position.1 as f32, z: 0.0},
